...
public class DianpuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,DianpuxinxiEntity dianpuxinxi,
		...
		if(tableName.equals("fangdong")) {
			dianpuxinxi.setFangdongzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
        ...
        dianpuxinxi = dianpuxinxiService.selectView(new EntityWrapper<DianpuxinxiEntity>().eq("id", id));
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<DianpuxinxiEntity> list = new ArrayList<DianpuxinxiEntity>();
        for(Long id : ids) {
            DianpuxinxiEntity dianpuxinxi = dianpuxinxiService.selectById(id);
            dianpuxinxi.setSfsh(sfsh);
            dianpuxinxi.setShhf(shhf);
            list.add(dianpuxinxi);
        }
        dianpuxinxiService.updateBatchById(list);
        return R.ok();
    }
