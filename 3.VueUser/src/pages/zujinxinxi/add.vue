...
<div :style='{"width":"80%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="100px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="商铺名称" prop="shangpumingcheng">
            <el-input v-model="ruleForm.shangpumingcheng" 
                placeholder="商铺名称" clearable :disabled=" false  ||ro.shangpumingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="商铺地址" prop="shangpudizhi">
            <el-input v-model="ruleForm.shangpudizhi" 
                placeholder="商铺地址" clearable :disabled=" false  ||ro.shangpudizhi"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="面积㎡" prop="dianpumianji">
			<el-input-number v-model="ruleForm.dianpumianji" placeholder="面积㎡" :readonly="ro.dianpumianji"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="租金费用" prop="zujinfeiyong">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="费用状态" prop="feiyongzhuangtai">
            <el-select v-model="ruleForm.feiyongzhuangtai" placeholder="请选择费用状态" :disabled=" false  ||ro.feiyongzhuangtai" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="租金详情" prop="zujinxiangqing">
            <editor 
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`zujinxinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('zujinxinxi/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`zujinxinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
