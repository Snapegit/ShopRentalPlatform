...
<div class="home-preview" :style='{"width":"100%","margin":"0 auto","flexDirection":"column","background":"#fff","display":"flex"}'>
	...
	<div id="animate_newsnews" class="news animate__animated" :style='{"width":"80%","margin":"30px auto","position":"relative","background":"#fff","order":"4"}'>
		...
		<div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
			<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>平台公告</span>
		</div>
...
<!-- 商品推荐 -->
<div id="animate_recommenddianpuxinxi" class="recommend animate__animated" :style='{"width":"80%","margin":"0 auto","position":"relative","background":"#fff","order":"2"}'>
    ...
    <div class="title" :style='{"margin":"10px 0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231122/a500d6f740e5474287d3831acdce1d92.png)","width":"30%","lineHeight":"54px","backgroundSize":"contain","backgroundPosition":"left top","backgroundRepeat":"no-repeat"}'>
		<span :style='{"color":"#000","fontSize":"32px","fontWeight":"bold"}'>店铺信息推荐</span>
	</div>
	...
	<div v-if="dianpuxinxiRecommend.length" class="list list12 index-pv1 list12dianpuxinxi" :style='{"width":"100%","padding":"10px","background":"#fff","display":"flex","height":"auto"}'>
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","flex":"1","background":"#fff","display":"flex","justifyContent":"space-between","height":"auto","order":"1"}'>
	    <div :style='{"border":"1px solid #D8D8D8","width":"calc(100% / 3 - 20px)","margin":"0 0 20px","position":"relative","borderWidth":"0 0 2px","height":"auto"}' class="item list-item animation-box" v-for="item,index in dianpuxinxiRecommend" :key="index" @click="toDetail('dianpuxinxiDetail', item)">
			...
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{item.shangpumingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>租金:{{item.zujin}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('dianpuxinxi')" :style='{"border":"1px solid #9E9E9E","margin":"0 0 0 -40px","top":"22px","textAlign":"center","left":"33%","background":"none","display":"block","width":"80px","lineHeight":"32px","position":"absolute"}'>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommenddianpuxinxi',css:'animate__rubberBand'},
      ...
      getSystemIntroduction() {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "dianpuxinxi/autoSort";
			data = {
				page: 1,
				limit: 6,
			}
			...
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.dianpuxinxiRecommend = res.data.data.list;
